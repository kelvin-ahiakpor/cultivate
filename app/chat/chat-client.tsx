              ...
              {sidebarOpen && (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  {unseenFlaggedUpdates > 0 && (
                    <span className="text-cultivate-golden-yellow text-sm font-semibold leading-none tabular-nums">
                ...
                <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto overflow-x-hidden">
                  ...
                  <div className={`sticky bottom-0 ${isStandalone ? "relative z-30 -mt-10 bg-transparent pb-4 pt-0" : "bg-cultivate-bg-main pb-2"}`}>
                    ...
                    <div className={`${isStandalone
                      ? `relative z-10 mx-auto mb-3 w-full ${isWelcomeComposerExpanded ? "max-w-[56rem] px-0" : "max-w-[54rem] px-3"} transition-all duration-200 ease-out`
