              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-cultivate-text-secondary">
                    Set your location so weather-aware tools and region-specific recommendations stay accurate
                  </p>
                </div>
              </div>
              ...
              <div className="bg-cultivate-bg-elevated border border-cultivate-border-element rounded-xl p-6">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-cultivate-text-secondary">
                      Get notified when a farmer flags a query that needs your review.
                    </p>
                  </div>
                </div>
